...
def observation_sensors():
    ...
    # Exibe os dados dos dois sensores
    print("Sensor 1 - Aceleração em g -> X: {:.2f}, Y: {:.2f}, Z: {:.2f}".format(ax1, ay1, az1))
    print("Sensor 2 - Aceleração em g -> X: {:.2f}, Y: {:.2f}, Z: {:.2f}".format(ax2, ay2, az2))
    ...
    if ant_ax1 != 0 and ant_ay1 != 0 and ant_az1 != 0:
        ...
        if dif_x1 > DIFERENCIAL or dif_y1 > DIFERENCIAL or dif_z1 > DIFERENCIAL:
            # Teve movimento no sensor 1
            print("Movimento detectado no Sensor 1")
            ocioso1 = 0
        else:
            ocioso1 = 1
    ...
    if ant_ax2 != 0 and ant_ay2 != 0 and ant_az2 != 0:
        ...
        if dif_x2 > DIFERENCIAL or dif_y2 > DIFERENCIAL or dif_z2 > DIFERENCIAL:
            # Teve movimento no sensor 2
            print("Movimento detectado no Sensor 2")
            ocioso2 = 0
        else:
            ocioso2 = 1
